      ...
      <div id="alls">
            ...
            <div id="box">
                  ...
                  <div class="control">
                        ...
                        <span class="cs" title="上一曲" @click="preSong"
                              >&lt;</span
                        >
                        <span class="cs">
                              <span v-if="pause" @click="open"> play </span>
                              <span v-else @click="pausex" title="暂停">
                                    ||
                              </span>
                        </span>
                        <span class="cs" @click="nextSong" title="下一曲"
                              >&gt;</span
                        >
                        <span
                              class="cs"
                              ...
                              >循环</span
                        >
                        <span @click="lookList" style="cursor:pointer"
                              >查看列表</span
                        >
                  </div>
            </div>
...
.small-player {
      ...
      .play-img {
            background: gray url(/image/img/music/play.png) no-repeat
                  center/contain;
      }
      .pause-img {
            background: gray url(/image/img/music/pause.png) no-repeat
                  center/60% 64%;
      }
}
#box {
