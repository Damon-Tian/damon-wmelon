            ...
            <div class="content article">
                  ...
                  >
                        ...
                        >
                              ...
                              <div
                                    v-if="item.subset"
                                    style="background-color:rgba(0,0,0,.02);margin-bottom:10px;box-shadow:0 0 10px 2px rgba(0,0,0,0.12)"
                              >
                                    <div
                                          v-for="(itemx,
                                          indexx) in item.subset.slice()"
                                          :key="itemx.id"
                                          style="display:flex;padding:10px 0 20px;position:relative;"
                                    >
                                          <img
...
.time {
      ...
      .comment {
            ...
            &::before {
                  ...
                  width: 22px;
                  height: 22px;
                  background: url("/image/img/comment.png") no-repeat
                        center/contain;
                  position: absolute;
